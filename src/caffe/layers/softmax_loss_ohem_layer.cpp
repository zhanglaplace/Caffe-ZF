...
void SoftmaxWithOHEMLayer<Dtype>::LayerSetUp(
...
template <typename Dtype>
void SoftmaxWithOHEMLayer<Dtype>::Reshape(
    const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
Dtype SoftmaxWithOHEMLayer<Dtype>::get_normalizer(
...
template <typename Dtype>
void SoftmaxWithOHEMLayer<Dtype>::Forward_cpu(
    const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void SoftmaxWithOHEMLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
#ifdef CPU_ONLY
STUB_GPU(SoftmaxWithOHEMLayer);
#endif

INSTANTIATE_CLASS(SoftmaxWithOHEMLayer);
REGISTER_LAYER_CLASS(SoftmaxWithOHEM);
