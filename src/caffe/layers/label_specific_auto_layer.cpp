...
namespace caffe {
  ...
  template <typename Dtype>
  void LabelSpecificAutoLayer<Dtype>::Reshape(const vector<Blob<Dtype>*>& bottom,
                                                    const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void LabelSpecificAutoLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
                                                  const vector<Blob<Dtype>*>& top) {
...
#ifdef CPU_ONLY
STUB_GPU(LabelSpecificAutoLayer);
#endif

INSTANTIATE_CLASS(LabelSpecificAutoLayer);
REGISTER_LAYER_CLASS(LabelSpecificAuto);
