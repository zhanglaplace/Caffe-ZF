#ifndef CAFFE_ANGULAR_TRIPLET_LAYER_HPP_
#define CAFFE_ANGULAR_TRIPLET_LAYER_HPP_
...
class AngularTripletLayer : public Layer<Dtype> {
 public:
  explicit AngularTripletLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
 ...
 protected:
  ...
  AngularTripletParameter_MarginType type_;
...
#endif  // CAFFE_ANGULAR_TRIPLET_LAYER_HPP_
