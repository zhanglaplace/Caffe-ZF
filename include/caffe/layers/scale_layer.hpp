...
class ScaleLayer: public Layer<Dtype> {
 ...
 protected:
  /**
   * In the below shape specifications, @fi@f denotes the value of the
   ...
   *      the first factor @fx@f
   *   -# @f(di×...×dj)@f
   *      the second factor @fy@f
   * @param top output Blob vector (length 1)
   *   -# @f$ (d_0 \times ... \times
   *           d_i \times ... \times d_j \times ... \times d_n) @f$
   *      the product @fz=xy@f computed after "broadcasting" y.
   *      Equivalent to tiling @fy@f to have the same shape as @fx@f,
