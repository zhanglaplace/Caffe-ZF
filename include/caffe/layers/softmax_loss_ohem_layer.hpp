#ifndef CAFFE_SOFTMAX_WITH_OHEM_LAYER_HPP_
#define CAFFE_SOFTMAX_WITH_OHEM_LAYER_HPP_
...
class SoftmaxWithOHEMLayer : public LossLayer<Dtype> {
 public:
  explicit SoftmaxWithOHEMLayer(const LayerParameter& param)
