 ...
 *   -# @f(N¡ÁC¡ÁH¡ÁW)@f
 *      the student's predictions @fx@f, a Blob with values in
 *      @f[?¡Þ,+¡Þ]@f indicating the predicted score for each of
 *      the @fK=CHW@f classes. This layer maps these scores to a
 ...
 *   -# @f(N¡ÁC¡ÁH¡ÁW)@f
 *      the teacher's predictions @fx@f, similar to that of the student.
 *   -# @f(N¡Á1¡Á1¡Á1)@f (optional)
 *      the labels @fl@f, an integer-valued Blob with values
 *      @fln¡Ê[0,1,2,...,K?1]@f
 *      indicating the correct class label among the @fK@f classes
 ...
 *      @f,forsoftmaxoutputclassprobabilites@f \hat{p} @f$ by the student
 *      and @fq^@f by the teacher
 *
